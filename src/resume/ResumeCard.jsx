...
const ResumeCard = ({title,subTitle,result,des}) => {
  return (
    <div className="w-full h-1/3  group flex">
        ...
        rounded-lg p-4 px-10 flex flex-col justify-center gap-10 shadow-shadowOne">
          ...
          <h3 className="text-2xl font-semibold group-hover:text-white duration-300">{title}</h3>
           ...
           <div>
            <p className="px-4 py-2  text-designColor bg-black bg-opacity-25 rounded-lg flex justify-center
            items-center shadow-shadowOne text-sm font-medium">{result}
            </p>
           </div>
           </div>
