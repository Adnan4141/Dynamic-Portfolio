...
const Card = ({title,des,icon}) => {
  return (
    <div className="w-full px-12 md:py-10 rounded-lg shadow-shadowOne
    ...
    duration-100">
      <div className="h-72 py-5 md:py-0 overflow-hidden">
      <div className="flex h-full  flex-col gap-10  translate-y-20 
